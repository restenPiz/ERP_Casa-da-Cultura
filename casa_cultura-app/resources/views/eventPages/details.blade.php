    ...
    <div class="card mb-3"><img class="card-img-top" src="{{ asset('storage/' . $event->Event_picture) }}" alt="" />
        <div class="card-body">
            <div class="row justify-content-between align-items-center">
                <div class="col">
                    <div class="d-flex">
                        <div class="calendar me-2"><span class="calendar-month">{{ \Carbon\Carbon::parse($event->Date)->format('M') }}
        ...
        <div class="col-lg-4 ps-lg-2">
            <div class="sticky-sidebar">
                <div class="card mb-3 fs-10">
                    <div class="card-body">
                        <h6>Data e Hora</h6>
                        <p class="mb-1">{{ \Carbon\Carbon::parse($event->Date)->format('d-m-Y') }}, {{ \Carbon\Carbon::parse($event->Hour)->format('H:i') }} </p>
