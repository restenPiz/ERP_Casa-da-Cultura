            ...
            <div class="shape-wrapper">
                <div class="shape-dot-wrapper shape-wrapper d-xl-block d-none">
                    ...
                    <div class="shape-image shape-image-3">
                        <img src="asset/images/shapes/shape-13-06-07.png"
                            alt="Shap
                                e Thumb" />
                    </div>
...
<div class="home-three-about edu-about-area about-style-4 bg-color-white edu-section-gapBottom">
    <div class="container eduvibe-animated-shape">
        ...
        <div class="shape-dot-wrapper shape-wrapper d-xl-block d-none">
            <div class="shape-image shape-image-1"><img src="asset/images/shapes/shape-03-08.png"
                    alt="Shape Thumb" /></div>
            <div class="shape-image shape-image-2"><img src="asset/images/shapes/shape-27.png" alt="Shape Thumb" />
            </div>
        </div>
    </div>
</div>
    ...
    <div
        ...
        <div class="container eduvibe-animated-shape">
            ...
            <div class="row g-5 mt--25">
                    ...
                    <div class="edu-card card-type-1 bg-white radius-small">
                        <div class="inner">
                            ...
                            <div class="content">
                                ...
                                <h6 class="title"><a href="course-details.html">Competitive Strategy law for all
                                        students</a>
                                </h6>
                ...
                <!-- Start Single Card  -->
                <div class="col-12 col-sm-12 col-xl-4 col-md-6" data-sal-delay="200" data-sal="slide-up"
                    data-sal-duration="800">
                    <div class="edu-card card-type-1 bg-white radius-small">
                        <div class="inner">
                            <div class="thumbnail">
                            ...
                            <div class="content">
                                ...
                                <h6 class="title"><a href="course-details.html">Machine Learning A-Z: Hands-On Python
                                        and
                                        java</a>
                                </h6>
                                <div class="edu-rating rating-default">
                ...
                <!-- Start Single Card  -->
                <div class="col-12 col-sm-12 col-xl-4 col-md-6" data-sal-delay="250" data-sal="slide-up"
                    data-sal-duration="800">
                    <div class="edu-card card-type-1 bg-white radius-small">
                        <div class="inner">
                            <div class="thumbnail">
                            ...
                            <div class="content">
                                ...
                                <h6 class="title"><a href="course-details.html">Achieving Advanced in Insights with
                                        Big</a>
                                </h6>
                                <div class="edu-rating rating-default">
                                    <div class="rating">
                ...
                <!-- Start Single Card  -->
                <div class="col-12 col-sm-12 col-xl-4 col-md-6" data-sal-delay="300" data-sal="slide-up"
                    data-sal-duration="800">
                    <div class="edu-card card-type-1 bg-white radius-small">
                        <div class="inner">
                            <div class="thumbnail">
                            ...
                            <div class="content">
                                ...
                                <h6 class="title"><a href="course-details.html">Education Makes A Person A
                                        Responsible
                                        Citizen</a>
                                </h6>
                                <div class="edu-rating rating-default">
                ...
                <!-- Start Single Card  -->
                <div class="col-12 col-sm-12 col-xl-4 col-md-6" data-sal-delay="350" data-sal="slide-up"
                    data-sal-duration="800">
                    <div class="edu-card card-type-1 bg-white radius-small">
                        <div class="inner">
                            <div class="thumbnail">
                            ...
                            <div class="content">
                                ...
                                <h6 class="title"><a href="course-details.html">Building A Better World One Student
                                        At A
                                        Time</a>
                                </h6>
                                <div class="edu-rating rating-default">
                ...
                <!-- Start Single Card  -->
                <div class="col-12 col-sm-12 col-xl-4 col-md-6" data-sal-delay="400" data-sal="slide-up"
                    data-sal-duration="800">
                    <div class="edu-card card-type-1 bg-white radius-small">
                        <div class="inner">
                            <div class="thumbnail">
                    ...
                    <div class="edu-footer-widget quick-link-widget">
                        ...
                        <div class="inner">
                            <ul class="footer-link link-hover">
                                ...
                                <li><a href="instructor-profile.html"><i class="icon-Double-arrow"></i>Instructor
                                        Profile</a></li>
                                <li><a href="faq.html"><i class="icon-Double-arrow"></i>FAQ</a></li>
                                <li><a href="course-style-3.html"><i class="icon-Double-arrow"></i>Popular Courses</a>
                                </li>
                        ...
                        <div class="inner">
                            <div class="widget-information">
                                <ul class="information-list">
                                    ...
                                    <li><i class="icon-phone-fill"></i><a href="tel:+1(237)382-2839">+ 1 (237)
                                            382-2839</a></li>
                                    <li><i class="icon-phone-fill"></i><a href="tel:+1(237)382-2840">+ 1 (237)
                                            382-2840</a></li>
                ...
                <div class="col-lg-12">
                    <div class="inner text-center">
                        <p>Copyright 2023 <a href="#">EduVibe</a> Designed By <a
                                href="https://themeforest.net/user/devsvibe">DevsVibe</a>. All Rights Reserved</p>
                    </div>
                </div>
            </div>
        </div>
