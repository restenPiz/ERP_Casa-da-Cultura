                                            ...
                                            <div class="p-4">
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-6"> <label class="form-label"
                                                            for="first-name">Primeiro Nome</label><input name="name"
                                                    ...
                                                    <div class="col-lg-6"><label class="form-label"
                                                            ...
                                                            name="password_confirmation" placeholder="Digite a Sua Senha"
                                                            class="form-control" id="email3" type="password" />
                                                    </div>

                                                    <div class="col-lg-6"> <label class="form-label"
                                                            for="email2">Numero de BI</label><input class="form-control"
                                                            id="email2" type="text" name="bi"
                                                            placeholder="0290290927329BS" /></div>
                                                    <div class="col-lg-6"> <label class="form-label" for="email2">Data
                                                            de Nascimento</label><input class="form-control"
                                                            id="email2" type="date" name="Date_of_birth" /></div>
                                                    <div class="col-lg-6"> <label class="form-label"
                                                            for="email2">Residencia</label><input class="form-control"
                                                            id="email2" type="text"
